...
fun Application.configureRouting(claudeService: ClaudeService, claudeConfig: ClaudeConfig) {
    ...
    routing {
        ...
        // API роуты для чата
        chatRoutes(claudeService, sessionManager, agentManager, claudeConfig)
